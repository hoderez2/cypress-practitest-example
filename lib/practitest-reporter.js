  ...
  for (const test of results.tests) {
    ...
    const payload = {
      data: {
        ...
        'test-attributes': {
          name: testName,
          // Sets the "Automation Status" custom field (ID: 278185) to "Automated" on test creation.
          // This field is only applied when auto_create creates the test for the first time;
          // it will not overwrite the value on subsequent runs.
          'custom-fields': {
            '---f-278185': 'Automated',
          },
        },
